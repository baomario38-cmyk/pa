...
// Đọc thông số API từ Environment Variables (mặc định lấy keys của bạn)
...
// Root route
app.get('/', (req, res) => {
    res.send('PayOS Server đang hoạt động trên Render!');
});
...
// Chạy Server cấu hình chuẩn cho Render (process.env.PORT)
